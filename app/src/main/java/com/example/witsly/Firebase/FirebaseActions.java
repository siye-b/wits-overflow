...
public class FirebaseActions {
    ...
    public void uploadPicture(Uri uri) {
        ...
        StorageReference reference = storageReference.child("images/" + FirebaseAuth.getInstance().getUid());
    ...
    public Uri getProfilePic() {
        StorageReference storageReference = storage.getReference();
        StorageReference pathReference = storageReference.child("images/" + FirebaseAuth.getInstance().getUid());
