...
public class RegisterActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    regButton.setOnClickListener(
        reg_btn -> {
          ...
          if (validateFields(
              email, password1, password2, name, surname, regEmail, regPasswordOne, regPasswordTwo))
  ...
  public boolean validateFields(
    ...
    if (!verifier.verifyEmail(email)) {
      ...
      passwordField1.setError(
          "Password must be at least be 8 characters long and contain at least "
